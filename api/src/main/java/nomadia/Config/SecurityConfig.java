    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/nomadia/trip/remove-self").hasRole("USER")
                        .requestMatchers("/nomadia/trip/delete").hasRole("USER")
                        .requestMatchers("/nomadia/trip/debts").hasRole("USER")
                        .requestMatchers("/nomadia/trip/settle-debt").hasRole("USER")
                        ...
                        .requestMatchers("/nomadia/activities/get-by-trip").hasRole("USER")
                        .requestMatchers("/nomadia/expense/create").hasRole("USER")
                        .requestMatchers("/nomadia/expense/update").hasRole("USER")
                        .requestMatchers("/nomadia/expense/delete").hasRole("USER")
                        .requestMatchers("/nomadia/expense/by-trip").hasRole("USER")
                        .requestMatchers("/nomadia/expense/by-activity").hasRole("USER")
                        .requestMatchers("/nomadia/expense/get").hasRole("USER")
                        .requestMatchers("/nomadia/expense/balance").hasRole("USER")
